...
import com.kronos.auth.dto.*;
import com.kronos.auth.util.OtpGenerator;
import com.kronos.common.crypto.Sha256;
...
import com.kronos.entity.enums.*;
...
import com.kronos.security.JwtService;
import com.kronos.security.SecurityProperties;
...
public class AuthService {
    ...
    private void sendOtpInternal(String email, OtpPurpose purpose) {
        ...
        String subject = (purpose == OtpPurpose.SIGNUP_VERIFY_EMAIL)
                ? "Kronos - Verify your email"
                : "Kronos - Reset your password";
